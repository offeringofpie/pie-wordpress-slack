<?php
  ...
  function handle_form() {
    global $option_sections;
    if (!isset($_POST['pie_slack_form']) || !wp_verify_nonce($_POST['pie_slack_form'], 'pie_slack_update')) {

      echo '<div class="error"><p>' . __('Something prevented your fields to update. Please try again', 'pie_slack') . '</p></div>';
    ...
    echo '<div class="updated"><p>' . __('Your Settings were successfully saved.', 'pie_slack') . '</p></div>';
  }
